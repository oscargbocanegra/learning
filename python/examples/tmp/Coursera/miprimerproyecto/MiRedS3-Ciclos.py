...
#
# Una caracteristica de los programas con múltiples funcionalidades es que ofrecen un menú de acciones
...
while continuar:
    ...
    #punto 2 modificacion de nombre
    modificaNombre = str(input('Deseas modificar tu nombre? (S/N) '))

    if modificaNombre == 'S' or modificaNombre == 's':
        nombre = input("Que nombre deseas ahora. ")
        ...
        """Modificacion de punto 1 unicamente cuando sea la letra N o n sale del programa"""
        ...
        # pasa, en la siguiente iteración el ciclo terminará¡
